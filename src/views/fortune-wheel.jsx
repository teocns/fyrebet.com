...
import FortuneWheelComponent from "../components/fortune-wheel/game";
  ...
  return (
    <Grid container className={classes.root} direction="row">
      <Grid item xs={12} md={12}>
        <FortuneWheelComponent className={classes.jackpotWheel} />
      </Grid>
      <Grid
        item
        xs={12}
...
export default FortuneWheelView;
